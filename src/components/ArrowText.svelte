        ...
        >
            {#if vertical}
                <text
                    ...
                    text-anchor="middle"
                >
                    <tspan x={center / 2.5} dy="0"
                        >Informe de la Cooperación</tspan
                    >
                    <tspan x={center / 2.5} dy="1.2em">
                        Sur-Sur y Triangular</tspan
                    >
                ...
                <path
                    d="M {center / 2.5},{47} L {center / 2.5},{firstPos +
                        textHeight +
                        arrowLength}"
                    stroke="#589ea4"
                    stroke-width="1"
            ...
            {:else}
                ...
                <text
                    ...
                    text-anchor="start"
                >
                    <tspan x={firstPos} dy="0"
                        >Informe de la Cooperación Sur-Sur</tspan
                    >
                    <tspan x={firstPos} dy="1.2em"
                        >y Triangular en Iberoamérica</tspan
                    >
                </text>
            {/if}
        </g>
        ...
        >
            {#if vertical}
                ...
                >
                    <tspan x={center + center / 1.5} dy="0"
                        >Agenda Internacional para</tspan
                    >
                    <tspan x={center + center / 1.5} dy="1.2em"
                        >el Desarrollo y Agenda</tspan
                    >
                    <tspan x={center + center / 1.5} dy="1.2em"
                        >Global CSS y Triangular</tspan
                    >
                </text>

                <!-- Flecha vertical hacia abajo -->
                <path
                    d="M {center + center / 1.5},{47} L {center +
            ...
            {:else}
                ...
                >
                    ...
                    <tspan x={firstPos} dy="1.2em">el Desarrollo y Agenda</tspan
                    >
                    <tspan x={firstPos} dy="1.2em"
                        >Global CSS y Triangular</tspan
                    >
